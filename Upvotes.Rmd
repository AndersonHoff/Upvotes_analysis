...
```
<br>
From the table above, we observe almost of Reputation data is in the first column. This means most of the Reputaion is low, and in this case, a graphic will not add any knowledge.
...
For the XGBoost analysis, the RMSE for the testing sample is `r xgb_rmse`.
